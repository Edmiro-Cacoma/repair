    ...
    return (
        <section className='flex items-center flex-wrap-reverse gap-12'>
            <div className="flex flex-1 basis-[42rem] p-4 flex-col items-start">
                <h3 className='capitalize text-veryBlackBlue pb-2 text-5xl'>serviços de reparo da melhor qualidade</h3>
                ...
                <a href="#services" className="inline-block mt-4 py-4 px-12 bg-white capitalize text-veryBlackBlue rounded-2xl border-[0.2rem] border-[#123456] hover:bg-lightBlue hover:text-white">leia +</a>
            </div>
